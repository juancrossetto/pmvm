					...
					>
						{typedPricingData.map((plan, index) => (
							...
							>
								...
								<div className='btn-box flex justify-center items-center gap-6 flex-col mt-8'>
									<Link
									...
									<Dialog>
										<DialogTrigger asChild>
											<Button
												variant='outline'
												className='!w-[180px] !h-[50px] border-primaryColor bg-darkColor hover:text-primaryColor hover:bg-darkColor'
											>
												{t("view_detail")}
											</Button>
										</DialogTrigger>
										<DialogContent className='mx-auto max-w-[22rem] sm:max-w-md bg-darkColor max-h-[95vh] overflow-y-auto'>
											...
											<Button className='w-full bg-primaryColor text-darkColor font-bold'>
												{t("i_want_to_start")}
