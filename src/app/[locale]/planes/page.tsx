...
const plans = [
  ...
  },
  {
    ...
    badge: 'MÁS POPULAR',
    color: '#c1ed00',
    description: '3 meses para construir hábitos reales. Ahorrás $10.000 vs. mes a mes.',
    features: [
  ...
  },
  {
    ...
    badge: 'MEJOR VALOR',
    color: '#ff734a',
    description: '6 meses de transformación completa. El camino para resultados duraderos.',
    features: [
